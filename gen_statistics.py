...
if __name__ == "__main__":
    ...
    tasks = zip(doc_ids, [processed_folder]*len(doc_ids),
                [fwd_index_folder]*len(doc_ids), [vocab]*len(doc_ids))
    tasks = list(tasks)
    ...
    pickle.dump(unigram_counts, open(statistics_folder + 'unigram_counts.pkl', 'wb'))

    pickle.dump(bigram_counts_raw, open(statistics_folder + 'bigram_counts_raw.pkl', 'wb'))
    pickle.dump(bigram_counts_gap, open(statistics_folder + 'bigram_counts_gap.pkl', 'wb'))
    pickle.dump(bigram_counts_inv, open(statistics_folder + 'bigram_counts_inv.pkl', 'wb'))

    pickle.dump(document_lengths, open(statistics_folder + 'document_lengths.pkl', 'wb'))
